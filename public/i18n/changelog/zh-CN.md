...
- **CodeBuddy 国际版模型目录刷新**：国际版目录按服务端重排（新增 Hy4-Preview / Hy3 免费档、GPT-5.6 Sol/Terra/Luna、GPT-5.5、GPT-5.4、GPT-5.3-Codex、Gemini-3.5-Flash、GLM-5.3、Kimi-K3 等，移除已下线的旧模型），并标注每模型积分倍率；CN 站目录未变
