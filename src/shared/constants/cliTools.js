...
export const CLI_TOOLS = {
  ...
  copilot: {
    ...
    color: "#1F6FEB",
    description: "GitHub Copilot in VS Code via router extension",
    configType: "guide",
    // VS Code extension that points Copilot Chat at a router-compatible
    // endpoint (server URL + API key) — replaces the old copilot MITM
    // interception, which GitHub's API hardening kept breaking.
    ...
    guideSteps: [
      ...
      },
      {
        ...
        desc: "Open Copilot Chat, click the model picker at the bottom → 'Manage Models...' → check the router models to use.",
      },
    ],
  },
  opencode: {
